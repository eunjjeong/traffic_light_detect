...
def detectAndDisplay(frame):
    ...
    for (x, y, w, h) in traffic_light:
        cv2.rectangle(frame, (x+5, y+5), (x+w-30, y+h+25), (255, 255, 255), 2, 8, 0)

        roi = gray[y+10:y+h+35, x+10:x+w-50]
...
parser.add_argument('--traffic_light_cascade', help='Path to traffic light cascade.', default='TrafficLight2.xml')
